import java.util.*;
public class CareerCounsellingPF {
    private static String loginName,firstName,lastName,userName,name="";
    private static String email,password,address,phone= "";
    ...
    public static void  account()
    {
        ...
        loginName = input.nextLine(); // Taking input for username
